# Aula_06_exe_04.py
#
# Stereo Chessboard Pixel Selection 
#
...
def mouse_handler(event, x, y, flags, params, img, window_name):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        points = [  (int(points_x[0]),int(-(points_x[0]*epilineR[0]+epilineR[2])/epilineR[1])), 
                    (int(points_x[1]), int(-(points_x[1]*epilineR[0]+epilineR[2])/epilineR[1]))   ]
